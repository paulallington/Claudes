...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  loadReviewComments: (projectPath, wsId, sessionId, scope, colId) => ipcRenderer.invoke('review-comments:load', projectPath, wsId, sessionId, scope, colId),
  saveReviewComments: (projectPath, wsId, sessionId, scope, comments, colId) => ipcRenderer.invoke('review-comments:save', projectPath, wsId, sessionId, scope, comments, colId),
  migrateReviewCommentsForColumn: (projectPath, wsId, oldSid, newSid, colId) => ipcRenderer.invoke('review-comments:migrateForColumn', projectPath, wsId, oldSid, newSid, colId),
