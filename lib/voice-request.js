 ...
 * @param {{ apiKey: string, voiceId: string, modelId?: string, text: string, voiceSettings?: object, previousText?: string, nextText?: string }} opts
...
function buildTtsRequest(opts) {
  ...
  if (typeof o.previousText === 'string' && o.previousText.length > 0) payload.previous_text = o.previousText;
  if (typeof o.nextText === 'string' && o.nextText.length > 0) payload.next_text = o.nextText;
  return {
