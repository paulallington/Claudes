...
(function () {
  ...
  // Each animation must stay on screen for at least this long before being
  // replaced. Stops the widget from "bouncing" when Claude alternates tools
  // rapidly (e.g. Read → Edit → Read). The latest queued state wins when
  // the hold expires.
  const MIN_ANIM_HOLD_MS = 5000;
