...
(function () {
  ...
  function applyPosition() {
    ...
    if (p) {
      ...
      const clamped = cp ? cp(p, { innerWidth: window.innerWidth, innerHeight: window.innerHeight }, { width: widgetEl.offsetWidth, height: widgetEl.offsetHeight }) : p;
    ...
    window.addEventListener('mousemove', (e) => {
      ...
      if (cp) {
        const clamped = cp(
          ...
          { width: widgetEl.offsetWidth, height: widgetEl.offsetHeight }
        );
        right = clamped.right;
