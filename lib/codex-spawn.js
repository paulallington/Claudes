...
(function () {
  ...
  function buildCodexRemoteAttach(semanticArgs, prepared, prompt) {
    ...
    // Remote resume inherits the thread's permissions; Codex rejects overrides.
    // Keep the semantic args intact for persistence and fresh/direct launches.
    var preset = prepared.mode === 'resume' ? 'codex-default' : codexPresetKeyFromArgs(semanticArgs || []);
