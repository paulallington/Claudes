 ...
 * @param {object} [raw]
 * @returns {{ enabled: boolean, mode: string, readingMode: string, voiceId: string, voiceName: string, modelId: string, maxChars: number, focusCatchUp: boolean, debugLog: boolean, personality: string, personalityPreset: string, stability: number, style: number, speed: number, similarityBoost: number, speakerBoost: boolean }}
 */
function normalizeVoiceSettings(raw) {
  ...
  return {
    ...
    debugLog: typeof r.debugLog === 'boolean' ? r.debugLog : false,
