...
//
// Loaded two ways:
//   - Node (pty-server.js + tests): require('./lib/spawn-resolve') via module.exports.
//   - Renderer: <script src="lib/spawn-resolve.js"> — attached to window since the
//     renderer runs under contextIsolation:true / nodeIntegration:false and cannot
//     require(). Same UMD pattern as lib/codex-spawn.js.
...
(function () {
  ...
  // CommonJS export for pty-server.js + tests; harmless in the browser.
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = api;
  }
  // Browser: namespace on window, matching sibling libs.
  if (typeof window !== 'undefined') {
    window.SpawnResolve = api;
  }
})();
