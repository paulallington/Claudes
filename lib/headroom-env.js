...
(function () {
  ...
  function buildHeadroomEnv(input) {
    ...
    if (input.oneM && input.oneMModel) {
      var modelId = String(input.oneMModel);
  ...
  function headroomModelWindow(input) {
    ...
    if (input.oneM && input.oneMModel && ClaudeModels) {
      return ClaudeModels.contextWindowFor(String(input.oneMModel));
    }
  ...
  var api = { buildHeadroomEnv: buildHeadroomEnv, buildHeadroomProxyArgs: buildHeadroomProxyArgs, headroomModelWindow: headroomModelWindow };
